...
| 常量 | 值 | 所在树 | 文档 |
|------|-----|--------|------|
| `BTRFS_INODE_ITEM_KEY` | 1 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_INODE_REF_KEY` | 12 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_INODE_EXTREF_KEY` | 13 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_XATTR_ITEM_KEY` | 24 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_VERITY_DESC_ITEM_KEY` | 36 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_VERITY_MERKLE_ITEM_KEY` | 37 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_ORPHAN_ITEM_KEY` | 48 | ROOT_TREE | [orphan-and-log.md](orphan-and-log.md) |
| `BTRFS_DIR_LOG_ITEM_KEY` | 60 | LOG_TREE | [orphan-and-log.md](orphan-and-log.md) |
| `BTRFS_DIR_LOG_INDEX_KEY` | 72 | LOG_TREE | [orphan-and-log.md](orphan-and-log.md) |
| `BTRFS_DIR_ITEM_KEY` | 84 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_DIR_INDEX_KEY` | 96 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_EXTENT_DATA_KEY` | 108 | FS_TREE | [fs-tree.md](fs-tree.md) |
| `BTRFS_EXTENT_CSUM_KEY` | 128 | CSUM_TREE | [csum-tree.md](csum-tree.md) |
| `BTRFS_ROOT_ITEM_KEY` | 132 | ROOT_TREE | [root-tree.md](root-tree.md) |
| `BTRFS_ROOT_BACKREF_KEY` | 144 | ROOT_TREE | [root-tree.md](root-tree.md) |
...
| `BTRFS_SHARED_DATA_REF_KEY` | 184 | EXTENT_TREE | [extent-tree.md](extent-tree.md) |
| `BTRFS_BLOCK_GROUP_ITEM_KEY` | 192 | EXTENT_TREE | [extent-tree.md](extent-tree.md) |
| `BTRFS_FREE_SPACE_INFO_KEY` | 198 | FREE_SPACE_TREE | [free-space-tree.md](free-space-tree.md) |
| `BTRFS_FREE_SPACE_EXTENT_KEY` | 199 | FREE_SPACE_TREE | [free-space-tree.md](free-space-tree.md) |
| `BTRFS_FREE_SPACE_BITMAP_KEY` | 200 | FREE_SPACE_TREE | [free-space-tree.md](free-space-tree.md) |
| `BTRFS_DEV_EXTENT_KEY` | 204 | DEV_TREE | [dev-tree.md](dev-tree.md) |
| `BTRFS_DEV_ITEM_KEY` | 216 | CHUNK_TREE | [chunk-tree.md](chunk-tree.md) |
| `BTRFS_CHUNK_ITEM_KEY` | 228 | CHUNK_TREE | [chunk-tree.md](chunk-tree.md) |
...
| `BTRFS_UUID_KEY_SUBVOL` | 251 | UUID_TREE | [uuid-tree.md](uuid-tree.md) |
| `BTRFS_UUID_KEY_RECEIVED_SUBVOL` | 252 | UUID_TREE | [uuid-tree.md](uuid-tree.md) |
